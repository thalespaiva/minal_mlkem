...
# This is an adaption of `run_exp_kyber2d_dfr.sh` to make smaller tests to
...
$build_directory/minal_src/dfr_computation/minal2d_dfr_computation  \
    experiments/setup/test_functional_exp_kyber2d_dfr.csv | tee \
    $reproduction_directory/results/kyber2d_dfr/test_functional_result_kyber2d_dfr.csv
