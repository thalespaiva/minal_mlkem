...
# This is an adaption of `reproduce_me.sh` to make smaller tests to
...
./experiments/scripts/test_functional_run_exp_kyber2d_dfr.sh $reproduction_directory $build_directory

# Generates 4D DFR results
./experiments/scripts/test_functional_run_exp_kyber4d_dfr.sh $reproduction_directory $build_directory
